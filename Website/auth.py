    ...
    if request.method == 'POST':
        ...
        if user:
            if check_password_hash(user.password,password):
               ...
               print(current_user)
               return redirect(url_for('views.home',message="Login Successful", category=True, username=current_user.firstName ))
            else:
    ...
    if request.method == 'POST':
       ...
       if(len(firstName)<2) :
          ...
          if user:
            ...
            return redirect(url_for('views.home',message="Account created successfully!", category=True,username=current_user.firstName ))
